...
public class AntennaStatusFragment extends BaseFragment {
    ...
    private void loadData(AntennaStatusBean antennaStatusBean) {
        tvAzi.setText(antennaStatusBean.getAzi() + "°");
        tvElevcarr.setText(antennaStatusBean.getElevcarr() + "°");
        tvLnglat.setText(ChechIpMask.numDigite2(antennaStatusBean.getCurlon(),2) + "E," +ChechIpMask.numDigite2(antennaStatusBean.getCurrlat(),2)  + "W");
        ...
        tvRoll.setText(antennaStatusBean.getRoll() + "°");
    ...
    private List<TroubleBean> getTroubleList(AntennaStatusBean antennaStatusBean) {
        ...
        if ("-1".equals(antennaStatusBean.getElevout())) {
            TroubleBean troubleBean=new TroubleBean("俯仰角状态","超方位");
            list.add(troubleBean);
        }
