...
public class SmartGatewayWarnInfoFragment extends BaseFragment{
    ...
    private void doAntennaAlarm() {
        ...
        try {
            ...
            baseActivity.http.send(HttpRequest.HttpMethod.POST, XTHttpUtil.devstatuAlarm, params,
